...
1. Убедитесь, что тариф/баланс SMS.to позволяет отправку на внешние номера.
2. Проверьте, что sender ID поддерживается страной получателя.
3. Для ограниченных аккаунтов проверьте список разрешённых получателей/ограничения.
4. Проверьте региональные ограничения и compliance (локальные требования, если применимо).
